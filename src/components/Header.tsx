	...
	return (
		<header className="flex justify-center px-4">
			<div className="max-w-[37.5rem] w-full px-4 my-12 mx-auto">
				<h1 className="text-5xl sm:text-4xl font-bold text-gray-800 m-0 mb-2 leading-tight">
					Mike Borthwick
				</h1>
				...
				<nav aria-label="Connect with me" className="mt-8">
					<ul className="list-none p-0 m-0 flex flex-col gap-1">
						<li>
							<a
								href="#resume"
								className="flex items-center py-2 text-gray-800 no-underline font-medium transition-all duration-200 min-h-[44px] hover:text-blue-500 focus:outline focus:outline-2 focus:outline-blue-500 focus:outline-offset-2"
								target="_blank"
